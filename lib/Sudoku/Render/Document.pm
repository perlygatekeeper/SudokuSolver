...
sub png {
    ...
    for my $r (0 .. 8) {
        for my $c (0 .. 8) {
            ...
            next if !$value;
            _digit(\@rows, $w, $h, $c * 50 + 13, $r * 50 + 9, $value, 1, $black);
        }
    }
...
# Experimental higher-resolution font, would have required rescaling grid and frankly didn't look that much better.
# Abandoned for now, likely png/pdf will be made by converting svg's
...
my %FONT = (
    1 => [qw(
        ...
        0011111111111110000000000
        0011111100111110000000000
    ...
    2 => [qw(
        ...
        0001111000000000111110000
        0001000000000000011111000
        0000000000000000001111100
        0000000000000000001111100
        0000000000000000001111100
        0000000000000000001111100
    ...
    4 => [qw(
        ...
        0000000000001111111000000
        0000000000011101111000000
        0000000000111001111000000
        0000000001111001111000000
        0000000001110001111000000
        0000000011100001111000000
        0000000111000001111000000
        0000001111000001111000000
        0000001110000001111000000
        0000011100000001111000000
        0000111000000001111000000
        0001111000000001111000000
        0001110000000001111000000
        0011111111111111111111100
        0011111111111111111111100
        0011111111111111111111100
    ...
    5 => [qw(
        ...
        0000111000000000000000000
        0000111000000000000000000
        0000111000111110000000000
        0000111111111111110000000
        0000111111111111111100000
        0000110000000011111110000
    ...
    6 => [qw(
        0000000000000000000000000
        0000000000000000000000000
        0000000000011111110000000
        0000000011111111111110000
        0000000111111111111110000
        0000001111100000000010000
        0000011110000000000000000
        0000111100000000000000000
        0001111000000000000000000
        0001111000000000000000000
        0001111000000000000000000
        0011110001111111110000000
        0011110111111111111100000
        0011111111000001111110000
        0011111110000000011111000
        0011111100000000001111000
        0011111000000000000111100
        0011111000000000000111100
        0001111000000000000111100
        0001111000000000000111100
        0001111000000000000111100
        0000111000000000001111000
        0000111100000000001111000
        0000011110000000111110000
    ...
    8 => [qw(
        ...
        0001111100000000011111000
        0001111000000000001111000
        0001111000000000001111000
        0001111000000000001111000
        ...
        0001111100000000011111000
        0001111000000000001111000
        0011110000000000000111100
        0011110000000000000111100
        0011110000000000000111100
        0011111000000000001111100
        0001111000000000001111000
        0001111100000000011111000
        0000111111111111111110000
        0000001111111111111000000
    ...
    9 => [qw(
        ...
        0000111110000000111100000
        0001111000000000011110000
        0001111000000000001110000
        0011110000000000001111000
        0011110000000000001111000
        0011110000000000001111000
        0011110000000000001111100
        0011110000000000001111100
        0001111000000000011111100
        0001111100000000111111100
        0000111111000001111111100
        0000011111111111110111100
        0000000111111111000111100
        0000000000000000001111000
        0000000000000000001111000
        0000000000000000001111000
        0000000000000000011110000
...
sub _digit {
    ...
    my $glyph_width = length $glyph->[0];

    for my $gy (0..$#$glyph) { for my $gx (0..$glyph_width) { next if substr($glyph->[$gy],$gx,1) ne '1';
