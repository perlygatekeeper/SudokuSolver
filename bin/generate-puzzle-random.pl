...
generate-puzzle-random.pl - generate reproducible Sudoku puzzles from the canonical corpus

=head1 SYNOPSIS

  bin/generate-puzzle-random.pl --seed 123 --clues 30
  bin/generate-puzzle-random.pl --seed 123 --clues 30 --difficulty Medium --format worksheet
  bin/generate-puzzle-random.pl --seed 123 --clues 30 --difficulty Medium --debug
  bin/generate-puzzle-random.pl --corpus-seed 10 --symmetry-seed 20 --reveal-seed 30 --format json
  bin/generate-puzzle-random.pl --seed 123 --difficulty Easy --max-score 3 --output-file generated.json --format json
