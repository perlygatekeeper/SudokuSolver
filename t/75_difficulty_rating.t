...
is($difficulty->rating_version, '1.5', 'difficulty rating records method version');
...
like($difficulty->summary, qr/v1\.5/, 'summary includes rating version');
like($difficulty->summary, qr/X-Wing/, 'summary includes highest strategy');

my $hash = $difficulty->as_hash;
is($hash->{rating_version}, '1.5', 'as_hash includes rating version');
