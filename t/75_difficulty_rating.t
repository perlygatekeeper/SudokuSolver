...
is($difficulty->rating_version, '2.4', 'difficulty rating records method version');
...
like($difficulty->summary, qr/v2\.4/, 'summary includes rating version');
like($difficulty->summary, qr/X-Wing/, 'summary includes highest strategy');

my $hash = $difficulty->as_hash;
is($hash->{rating_version}, '2.4', 'as_hash includes rating version');
