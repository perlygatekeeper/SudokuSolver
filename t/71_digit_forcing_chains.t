...
my $contradiction_on_grid = Grid->new;
$contradiction_on_grid->load_from_string('0' x 81);
set_candidates($contradiction_on_grid->cell_from_row_column(0, 0), 1);

my $contradiction_off_grid = Grid->new;
$contradiction_off_grid->load_from_string('0' x 81);
...
my $common_source = Grid->new;
$common_source->load_from_string('0' x 81);
...
my $off_grid = Grid->new;
$off_grid->load_from_string('0' x 81);
...
my $placement_source = Grid->new;
$placement_source->load_from_string('0' x 81);
set_candidates($placement_source->cell_from_row_column(0, 0), 1, 2);
set_candidates($placement_source->cell_from_row_column(3, 3), 5, 6);

my $placement_on = Grid->new;
$placement_on->load_from_string('0' x 81);
...
my $placement_off = Grid->new;
$placement_off->load_from_string('0' x 81);
