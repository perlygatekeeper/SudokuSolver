...
gitadd:
	git add Makefile Readme.md $(SCRIPT) $(MODS) $(VERSION_MOD) $(TESTDIR)*.t $(DOCSDIR)*.txt $(DOCSDIR)Developer/*.md $(DOCSDIR)Algorithm_Notes/*.md $(DOCSDIR)Strategies/*.md Puzzles/Examples/*.sdk $(PUZZLEDIR)*.txt $(CPANFILE)
	git status
